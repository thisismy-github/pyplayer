...
def connect_widget_signals(self: QtW.QMainWindow):
    ...
    self.actionOpenMediaLocation.triggered.connect(self.explore_media_location)
    self.actionCopyMediaLocation.triggered.connect(self.copy_media_location)
    ...
    self.actionSnapshotExploreLast.triggered.connect(lambda: self.explore_media_location(config.cfg.last_snapshot_path, 'Last snapshot'))
    self.actionSnapshotCopyLast.triggered.connect(lambda: self.copy_media_location(config.cfg.last_snapshot_path, 'Last snapshot'))
