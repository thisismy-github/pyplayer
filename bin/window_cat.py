...
class Ui_catDialog(object):
    def setupUi(self, catDialog):
        ...
        self.gridLayout.addWidget(self.recent, 7, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.buttonBox, 7, 7, 1, 1)
        ...
        spacerItem2 = QtWidgets.QSpacerItem(15, 20, QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Minimum)
...
"Click the icon on the left to add the actual most recently played file."))
