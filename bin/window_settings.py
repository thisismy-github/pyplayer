...
"Leave blank to always save unspecified videos to their source folder.")
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.SpanningRole, self.checkAlwaysSaveAs)
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.SpanningRole, self.checkSaveAsUseMediaFolder)
        self.checkStopOnFinish = QtWidgets.QCheckBox(self.tabGeneral)
        self.checkStopOnFinish.setObjectName("checkStopOnFinish")
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.SpanningRole, self.checkStopOnFinish)
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.SpanningRole, self.checkNavigationWrap)
