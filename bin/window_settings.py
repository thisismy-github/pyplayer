...
class Ui_settingsDialog(object):
    def setupUi(self, settingsDialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -69, 334, 1447))
        ...
        self.theme_combo = QtWidgets.QComboBox(self.tabGeneral)
        self.theme_combo.setToolTip("The currently applied theme. Themes are stored in your installation directory\'s \"themes\" folder as .json, .css, .qss, or .txt files.")
        self.theme_combo.setObjectName("theme_combo")
        self.theme_combo.addItem("")
        self.horizontalLayout.addWidget(self.theme_combo)
        self.theme_refresh_button = QtWidgets.QPushButton(self.tabGeneral)
        self.theme_refresh_button.setMaximumSize(QtCore.QSize(22, 22))
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(False)
        font.setWeight(50)
        self.theme_refresh_button.setFont(font)
        self.theme_refresh_button.setToolTip("Refresh theme list")
        self.theme_refresh_button.setStyleSheet("QPushButton { padding-bottom: 3px; }")
        self.theme_refresh_button.setText("⟳")
        self.theme_refresh_button.setObjectName("theme_refresh_button")
        self.horizontalLayout.addWidget(self.theme_refresh_button)
        self.formLayout.setLayout(0, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout)
        self.windowTitleLabel = QtWidgets.QLabel(self.tabGeneral)
        self.windowTitleLabel.setObjectName("windowTitleLabel")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.windowTitleLabel)
...
"Leave blank to always save unspecified videos to their source folder.")
        ...
        self.lineDefaultPath = QtWidgets.QLineEdit(self.tabGeneral)
        self.lineDefaultPath.setPlaceholderText("Same as source media")
        self.lineDefaultPath.setObjectName("lineDefaultPath")
        self.horizontalLayout_2.addWidget(self.lineDefaultPath)
        self.default_path_browse = QtWidgets.QPushButton(self.tabGeneral)
        self.default_path_browse.setMinimumSize(QtCore.QSize(22, 22))
        self.default_path_browse.setToolTip("Refresh theme list")
        self.default_path_browse.setStyleSheet("QPushButton { padding-bottom: 3px; }")
        self.default_path_browse.setText("...")
        self.default_path_browse.setObjectName("default_path_browse")
        self.horizontalLayout_2.addWidget(self.default_path_browse)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.spinVolumeScroll)
        ...
        self.checkHighPrecisionTrim = QtWidgets.QCheckBox(self.tabGeneral)
        self.checkHighPrecisionTrim.setObjectName("checkHighPrecisionTrim")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.SpanningRole, self.checkHighPrecisionTrim)
        ...
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.SpanningRole, self.checkResizeOnOpen)
        ...
        self.formLayout.setWidget(13, QtWidgets.QFormLayout.SpanningRole, self.checkSnapOnOpen)
        ...
        self.formLayout.setWidget(14, QtWidgets.QFormLayout.SpanningRole, self.checkSnapOnResize)
        ...
        self.snapshotNameFormatLabel = QtWidgets.QLabel(self.groupBox_3)
        self.snapshotNameFormatLabel.setObjectName("snapshotNameFormatLabel")
        self.formLayout_4.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.snapshotNameFormatLabel)
        ...
        self.snapshotNameFormatLabel_2 = QtWidgets.QLabel(self.groupBox_3)
        self.snapshotNameFormatLabel_2.setObjectName("snapshotNameFormatLabel_2")
        self.formLayout_4.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.snapshotNameFormatLabel_2)
...
"        All days in a new year preceding the first Monday are considered to be in week 0.")
        ...
        self.imageFormatLabel = QtWidgets.QLabel(self.groupBox_3)
        self.imageFormatLabel.setObjectName("imageFormatLabel")
        self.formLayout_4.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.imageFormatLabel)
        ...
        self.snapshotJPEGQualityLabel = QtWidgets.QLabel(self.groupBox_3)
        self.snapshotJPEGQualityLabel.setObjectName("snapshotJPEGQualityLabel")
        self.formLayout_4.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.snapshotJPEGQualityLabel)
    ...
    def retranslateUi(self, settingsDialog):
        ...
        self.theme_combo.setCurrentText(_translate("settingsDialog", "None"))
        self.theme_combo.setItemText(0, _translate("settingsDialog", "None"))
        self.windowTitleLabel.setToolTip(_translate("settingsDialog", "The format to use for setting the title of the window. The\n"
...
"?speed        The playback speed of the media being played."))
        self.windowTitleLabel.setText(_translate("settingsDialog", "Window title format"))
...
"otherwise, the progress bar will fall behind and start to desync."))
        ...
        self.checkHighPrecisionTrim.setToolTip(_translate("settingsDialog", "If checked, trimmed videos will always be re-encoded to ensure 100% accuracy\n"
"at the start of the trim. Otherwise, certain formats, such as MP4 files, will have\n"
"the starts of their videos trimmed to the nearest keyframe (which varies from\n"
"video to video), as this is a nearly instant operation. Re-encoding is intensive\n"
"and can take nearly twice as long as the trimmed clip\'s length for some formats.\n"
"\n"
"Note 1: Formats that cannot be instantly trimmed without\n"
"re-encoding will default to high-precision trimming regardless.\n"
"\n"
"Note 2: Keyframe trimming only introduces inaccuracy to the\n"
"start of a trim. The end of a trim will always be accurate."))
        self.checkHighPrecisionTrim.setText(_translate("settingsDialog", "Always use high-precision trims (slow)"))
...
"visible as a visual cue once the current media finishes."))
        ...
        self.snapshotNameFormatLabel.setToolTip(_translate("settingsDialog", "The format to use for naming snapshots. The following variables are replaced with their corresponding values:\n"
"\n"
...
"    unique, default Windows-naming conventions will be used: \"base (count).extension\""))
        self.snapshotNameFormatLabel.setText(_translate("settingsDialog", "Snapshot Name Format"))
...
"    unique, default Windows-naming conventions will be used: \"base (count).extension\""))
        ...
        self.snapshotNameFormatLabel_2.setToolTip(_translate("settingsDialog", "The format to use for the ?date variable in snapshot names.\n"
"Formatting is based on strftime formatting. Hover over the ?\n"
"button to see most (but not all) of the available format codes."))
        self.snapshotNameFormatLabel_2.setText(_translate("settingsDialog", "Snapshot Date Format"))
        ...
        self.imageFormatLabel.setText(_translate("settingsDialog", "Snapshot Image Format"))
        ...
        self.snapshotJPEGQualityLabel.setToolTip(_translate("settingsDialog", "The quality to use for JPEG-format snapshots."))
        self.snapshotJPEGQualityLabel.setText(_translate("settingsDialog", "Snapshot JPEG Quality"))
