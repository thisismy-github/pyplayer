...
"Leave blank to always save unspecified videos to their source folder.")
        ...
        self.comboScaleImages = QtWidgets.QComboBox(self.groupBox)
        ...
        self.comboScaleImages.addItem("")
        self.comboScaleImages.addItem("")
        self.formLayout_8.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.comboScaleImages)
        ...
        self.comboScaleArt.addItem("")
        self.comboScaleArt.addItem("")
        self.formLayout_8.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.comboScaleArt)
        ...
        self.comboScaleGifs.addItem("")
        self.comboScaleGifs.addItem("")
        self.formLayout_8.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.comboScaleGifs)
        self.checkShowCoverArt = QtWidgets.QCheckBox(self.groupBox)
        ...
        self.formLayout_11.setVerticalSpacing(3)
        ...
        self.checkAutoplaySameMime = QtWidgets.QCheckBox(self.groupBox_9)
        self.checkAutoplaySameMime.setObjectName("checkAutoplaySameMime")
        self.formLayout_11.setWidget(2, QtWidgets.QFormLayout.SpanningRole, self.checkAutoplaySameMime)
        self.checkAutoplayIgnoreFocus = QtWidgets.QCheckBox(self.groupBox_9)
        self.checkAutoplayIgnoreFocus.setChecked(True)
        self.checkAutoplayIgnoreFocus.setObjectName("checkAutoplayIgnoreFocus")
        self.formLayout_11.setWidget(3, QtWidgets.QFormLayout.SpanningRole, self.checkAutoplayIgnoreFocus)
        ...
        self.formLayout_11.setWidget(4, QtWidgets.QFormLayout.SpanningRole, self.checkAutoplayAddToRecents)
        ...
        self.formLayout_11.setWidget(5, QtWidgets.QFormLayout.SpanningRole, self.checkAutoplayShuffleAddToRecents)
        ...
        self.spinZoomIncrement.setMinimum(2)
        self.spinZoomIncrement.setMaximum(100)
        self.spinZoomIncrement.setProperty("value", 6)
        ...
        self.spinZoomCtrlIncrement.setMinimum(2)
        ...
        self.spinZoomShiftIncrement.setMinimum(2)
...
"        All days in a new year preceding the first Monday are considered to be in week 0.")
        ...
        self.formLayout_12.setVerticalSpacing(2)
        ...
        self.formLayout_12.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_72)
        ...
        self.comboSnapshotShift.addItem("")
        self.comboSnapshotShift.addItem("")
        self.formLayout_12.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.comboSnapshotShift)
        self.label_75 = QtWidgets.QLabel(self.groupBox_8)
        self.label_75.setObjectName("label_75")
        self.formLayout_12.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_75)
        ...
        self.comboSnapshotCtrl.addItem("")
        self.comboSnapshotCtrl.addItem("")
        self.formLayout_12.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.comboSnapshotCtrl)
        ...
        spacerItem4 = QtWidgets.QSpacerItem(1, 3, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.formLayout_4.setItem(11, QtWidgets.QFormLayout.SpanningRole, spacerItem4)
        ...
        self.formLayout_3.setContentsMargins(9, 9, 9, -1)
        self.formLayout_3.setVerticalSpacing(10)
        self.formLayout_3.setObjectName("formLayout_3")
        self.groupBox_5 = QtWidgets.QGroupBox(self.tabKeys)
        ...
        self.formLayout_9.setContentsMargins(-1, 5, -1, 7)
        ...
        self.groupBox_10 = QtWidgets.QGroupBox(self.tabKeys)
        self.groupBox_10.setObjectName("groupBox_10")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.groupBox_10)
        self.gridLayout_3.setContentsMargins(-1, 5, -1, 7)
        self.gridLayout_3.setVerticalSpacing(3)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.checkNavigationUnpause = QtWidgets.QCheckBox(self.groupBox_10)
        self.checkNavigationUnpause.setChecked(True)
        self.checkNavigationUnpause.setObjectName("checkNavigationUnpause")
        self.gridLayout_3.addWidget(self.checkNavigationUnpause, 1, 0, 1, 2)
        self.checkNavigationWrap = QtWidgets.QCheckBox(self.groupBox_10)
        self.checkNavigationWrap.setChecked(True)
        self.checkNavigationWrap.setObjectName("checkNavigationWrap")
        self.gridLayout_3.addWidget(self.checkNavigationWrap, 0, 0, 1, 2)
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.SpanningRole, self.groupBox_10)
        self.groupBox_11 = QtWidgets.QGroupBox(self.tabKeys)
        self.groupBox_11.setObjectName("groupBox_11")
        self.formLayout_13 = QtWidgets.QFormLayout(self.groupBox_11)
        self.formLayout_13.setContentsMargins(-1, 5, -1, 7)
        self.formLayout_13.setVerticalSpacing(3)
        self.formLayout_13.setObjectName("formLayout_13")
        self.label_33 = QtWidgets.QLabel(self.groupBox_11)
        self.label_33.setObjectName("label_33")
        self.formLayout_13.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_33)
        self.spinVolumeScroll = QtWidgets.QSpinBox(self.groupBox_11)
        ...
        self.plus2 = QKeySequenceFlexibleEdit(self.tabKeys)
        self.plus2.setObjectName("plus2")
        self.horizontalLayout_10.addWidget(self.plus2)
        self.plus2_ = QKeySequenceFlexibleEdit(self.tabKeys)
        self.plus2_.setObjectName("plus2_")
        self.horizontalLayout_10.addWidget(self.plus2_)
        self.formKeys.setLayout(3, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_10)
        self.labelNavigation2 = QtWidgets.QLabel(self.tabKeys)
        self.labelNavigation2.setObjectName("labelNavigation2")
        self.formKeys.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.labelNavigation2)
        self.horizontalLayout_11 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_11.setSpacing(4)
        self.horizontalLayout_11.setObjectName("horizontalLayout_11")
        self.minus2 = QKeySequenceFlexibleEdit(self.tabKeys)
        self.minus2.setObjectName("minus2")
        self.horizontalLayout_11.addWidget(self.minus2)
        self.minus2_ = QKeySequenceFlexibleEdit(self.tabKeys)
        self.minus2_.setObjectName("minus2_")
        self.horizontalLayout_11.addWidget(self.minus2_)
        self.formKeys.setLayout(4, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_11)
        self.horizontalLayout_12 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_12.setSpacing(4)
        self.horizontalLayout_12.setObjectName("horizontalLayout_12")
        self.plus3 = QKeySequenceFlexibleEdit(self.tabKeys)
        self.plus3.setObjectName("plus3")
        self.horizontalLayout_12.addWidget(self.plus3)
        self.plus3_ = QKeySequenceFlexibleEdit(self.tabKeys)
        self.plus3_.setObjectName("plus3_")
        self.horizontalLayout_12.addWidget(self.plus3_)
        self.formKeys.setLayout(5, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_12)
        self.labelNavigation3 = QtWidgets.QLabel(self.tabKeys)
        self.labelNavigation3.setObjectName("labelNavigation3")
        self.formKeys.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.labelNavigation3)
        self.horizontalLayout_13 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_13.setSpacing(4)
        self.horizontalLayout_13.setObjectName("horizontalLayout_13")
        self.minus3 = QKeySequenceFlexibleEdit(self.tabKeys)
        self.minus3.setObjectName("minus3")
        self.horizontalLayout_13.addWidget(self.minus3)
        self.minus3_ = QKeySequenceFlexibleEdit(self.tabKeys)
        self.minus3_.setObjectName("minus3_")
        self.horizontalLayout_13.addWidget(self.minus3_)
        self.formKeys.setLayout(6, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_13)
        self.horizontalLayout_16 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_16.setSpacing(4)
        self.horizontalLayout_16.setObjectName("horizontalLayout_16")
        self.plus4 = QKeySequenceFlexibleEdit(self.tabKeys)
        self.plus4.setObjectName("plus4")
        self.horizontalLayout_16.addWidget(self.plus4)
        self.plus4_ = QKeySequenceFlexibleEdit(self.tabKeys)
        self.plus4_.setObjectName("plus4_")
        self.horizontalLayout_16.addWidget(self.plus4_)
        self.formKeys.setLayout(7, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_16)
        self.labelNavigation4 = QtWidgets.QLabel(self.tabKeys)
        self.labelNavigation4.setObjectName("labelNavigation4")
        self.formKeys.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.labelNavigation4)
        self.horizontalLayout_41 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_41.setSpacing(4)
        self.horizontalLayout_41.setObjectName("horizontalLayout_41")
        self.minus4 = QKeySequenceFlexibleEdit(self.tabKeys)
        self.minus4.setObjectName("minus4")
        self.horizontalLayout_41.addWidget(self.minus4)
        self.minus4_ = QKeySequenceFlexibleEdit(self.tabKeys)
        self.minus4_.setObjectName("minus4_")
        self.horizontalLayout_41.addWidget(self.minus4_)
        self.formKeys.setLayout(8, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_41)
        self.label_12 = QtWidgets.QLabel(self.tabKeys)
        self.label_12.setObjectName("label_12")
        self.formKeys.setWidget(9, QtWidgets.QFormLayout.LabelRole, self.label_12)
        ...
        self.formKeys.setLayout(9, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_14)
        self.label_13 = QtWidgets.QLabel(self.tabKeys)
        self.label_13.setObjectName("label_13")
        self.formKeys.setWidget(10, QtWidgets.QFormLayout.LabelRole, self.label_13)
        ...
        self.formKeys.setLayout(10, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_17)
        self.label_18 = QtWidgets.QLabel(self.tabKeys)
        self.label_18.setObjectName("label_18")
        self.formKeys.setWidget(11, QtWidgets.QFormLayout.LabelRole, self.label_18)
        ...
        self.formKeys.setLayout(11, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_22)
        self.label_19 = QtWidgets.QLabel(self.tabKeys)
        self.label_19.setObjectName("label_19")
        self.formKeys.setWidget(12, QtWidgets.QFormLayout.LabelRole, self.label_19)
        ...
        self.formKeys.setLayout(12, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_23)
        self.label_14 = QtWidgets.QLabel(self.tabKeys)
        self.label_14.setObjectName("label_14")
        self.formKeys.setWidget(13, QtWidgets.QFormLayout.LabelRole, self.label_14)
        ...
        self.formKeys.setLayout(13, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_18)
        self.label_15 = QtWidgets.QLabel(self.tabKeys)
        self.label_15.setObjectName("label_15")
        self.formKeys.setWidget(14, QtWidgets.QFormLayout.LabelRole, self.label_15)
        ...
        self.formKeys.setLayout(14, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_19)
        self.label_22 = QtWidgets.QLabel(self.tabKeys)
        self.label_22.setObjectName("label_22")
        self.formKeys.setWidget(15, QtWidgets.QFormLayout.LabelRole, self.label_22)
        ...
        self.formKeys.setLayout(15, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_26)
        self.label_23 = QtWidgets.QLabel(self.tabKeys)
        self.label_23.setObjectName("label_23")
        self.formKeys.setWidget(16, QtWidgets.QFormLayout.LabelRole, self.label_23)
        ...
        self.formKeys.setLayout(16, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_27)
        self.label_16 = QtWidgets.QLabel(self.tabKeys)
        self.label_16.setObjectName("label_16")
        self.formKeys.setWidget(17, QtWidgets.QFormLayout.LabelRole, self.label_16)
        ...
        self.formKeys.setLayout(17, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_20)
        self.label_17 = QtWidgets.QLabel(self.tabKeys)
        self.label_17.setObjectName("label_17")
        self.formKeys.setWidget(18, QtWidgets.QFormLayout.LabelRole, self.label_17)
        ...
        self.formKeys.setLayout(18, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_21)
        self.label_24 = QtWidgets.QLabel(self.tabKeys)
        self.label_24.setObjectName("label_24")
        self.formKeys.setWidget(19, QtWidgets.QFormLayout.LabelRole, self.label_24)
        ...
        self.formKeys.setLayout(19, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_28)
        self.label_32 = QtWidgets.QLabel(self.tabKeys)
        self.label_32.setObjectName("label_32")
        self.formKeys.setWidget(20, QtWidgets.QFormLayout.LabelRole, self.label_32)
        ...
        self.formKeys.setLayout(20, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_37)
        self.label_20 = QtWidgets.QLabel(self.tabKeys)
        self.label_20.setObjectName("label_20")
        self.formKeys.setWidget(21, QtWidgets.QFormLayout.LabelRole, self.label_20)
        ...
        self.formKeys.setLayout(21, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_24)
        self.label_21 = QtWidgets.QLabel(self.tabKeys)
        self.label_21.setObjectName("label_21")
        self.formKeys.setWidget(22, QtWidgets.QFormLayout.LabelRole, self.label_21)
        ...
        self.formKeys.setLayout(22, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_25)
        self.label_59 = QtWidgets.QLabel(self.tabKeys)
        self.label_59.setObjectName("label_59")
        self.formKeys.setWidget(23, QtWidgets.QFormLayout.LabelRole, self.label_59)
        self.horizontalLayout_30 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_30.setSpacing(4)
        self.horizontalLayout_30.setObjectName("horizontalLayout_30")
        self.forward = QKeySequenceFlexibleEdit(self.tabKeys)
        self.forward.setObjectName("forward")
        self.horizontalLayout_30.addWidget(self.forward)
        self.forward_ = QKeySequenceFlexibleEdit(self.tabKeys)
        self.forward_.setObjectName("forward_")
        self.horizontalLayout_30.addWidget(self.forward_)
        self.formKeys.setLayout(23, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_30)
        self.label_60 = QtWidgets.QLabel(self.tabKeys)
        self.label_60.setObjectName("label_60")
        self.formKeys.setWidget(24, QtWidgets.QFormLayout.LabelRole, self.label_60)
        self.horizontalLayout_38 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_38.setSpacing(4)
        self.horizontalLayout_38.setObjectName("horizontalLayout_38")
        self.back = QKeySequenceFlexibleEdit(self.tabKeys)
        self.back.setObjectName("back")
        self.horizontalLayout_38.addWidget(self.back)
        self.back_ = QKeySequenceFlexibleEdit(self.tabKeys)
        self.back_.setObjectName("back_")
        self.horizontalLayout_38.addWidget(self.back_)
        self.formKeys.setLayout(24, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_38)
        self.label_25 = QtWidgets.QLabel(self.tabKeys)
        self.label_25.setObjectName("label_25")
        self.formKeys.setWidget(25, QtWidgets.QFormLayout.LabelRole, self.label_25)
        ...
        self.formKeys.setLayout(25, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_29)
        self.label_26 = QtWidgets.QLabel(self.tabKeys)
        self.label_26.setObjectName("label_26")
        self.formKeys.setWidget(26, QtWidgets.QFormLayout.LabelRole, self.label_26)
        ...
        self.formKeys.setLayout(26, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_31)
        self.label_27 = QtWidgets.QLabel(self.tabKeys)
        self.label_27.setObjectName("label_27")
        self.formKeys.setWidget(27, QtWidgets.QFormLayout.LabelRole, self.label_27)
        ...
        self.formKeys.setLayout(27, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_32)
        self.label_66 = QtWidgets.QLabel(self.tabKeys)
        self.label_66.setObjectName("label_66")
        self.formKeys.setWidget(28, QtWidgets.QFormLayout.LabelRole, self.label_66)
        self.horizontalLayout_39 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_39.setSpacing(4)
        self.horizontalLayout_39.setObjectName("horizontalLayout_39")
        self.cycleaudio_ = QKeySequenceFlexibleEdit(self.tabKeys)
        self.cycleaudio_.setObjectName("cycleaudio_")
        self.horizontalLayout_39.addWidget(self.cycleaudio_)
        self.cycleaudio = QKeySequenceFlexibleEdit(self.tabKeys)
        self.cycleaudio.setObjectName("cycleaudio")
        self.horizontalLayout_39.addWidget(self.cycleaudio)
        self.formKeys.setLayout(28, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_39)
        self.label_67 = QtWidgets.QLabel(self.tabKeys)
        self.label_67.setObjectName("label_67")
        self.formKeys.setWidget(29, QtWidgets.QFormLayout.LabelRole, self.label_67)
        self.horizontalLayout_40 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_40.setSpacing(4)
        self.horizontalLayout_40.setObjectName("horizontalLayout_40")
        self.cyclevideo = QKeySequenceFlexibleEdit(self.tabKeys)
        self.cyclevideo.setObjectName("cyclevideo")
        self.horizontalLayout_40.addWidget(self.cyclevideo)
        self.cyclevideo_ = QKeySequenceFlexibleEdit(self.tabKeys)
        self.cyclevideo_.setObjectName("cyclevideo_")
        self.horizontalLayout_40.addWidget(self.cyclevideo_)
        self.formKeys.setLayout(29, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_40)
        self.label_28 = QtWidgets.QLabel(self.tabKeys)
        self.label_28.setObjectName("label_28")
        self.formKeys.setWidget(30, QtWidgets.QFormLayout.LabelRole, self.label_28)
        ...
        self.formKeys.setLayout(30, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_33)
        self.label_29 = QtWidgets.QLabel(self.tabKeys)
        self.label_29.setObjectName("label_29")
        self.formKeys.setWidget(31, QtWidgets.QFormLayout.LabelRole, self.label_29)
        ...
        self.formKeys.setLayout(31, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_34)
        self.label_30 = QtWidgets.QLabel(self.tabKeys)
        self.label_30.setObjectName("label_30")
        self.formKeys.setWidget(32, QtWidgets.QFormLayout.LabelRole, self.label_30)
        ...
        self.formKeys.setLayout(32, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_35)
        self.label_31 = QtWidgets.QLabel(self.tabKeys)
        self.label_31.setObjectName("label_31")
        self.formKeys.setWidget(33, QtWidgets.QFormLayout.LabelRole, self.label_31)
        ...
        self.formKeys.setLayout(33, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_36)
        self.horizontalLayout_42 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_42.setSpacing(4)
        self.horizontalLayout_42.setObjectName("horizontalLayout_42")
        self.minus1 = QKeySequenceFlexibleEdit(self.tabKeys)
        self.minus1.setObjectName("minus1")
        self.horizontalLayout_42.addWidget(self.minus1)
        self.minus1_ = QKeySequenceFlexibleEdit(self.tabKeys)
        self.minus1_.setObjectName("minus1_")
        self.horizontalLayout_42.addWidget(self.minus1_)
        self.formKeys.setLayout(2, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_42)
        self.labelNavigation1 = QtWidgets.QLabel(self.tabKeys)
        self.labelNavigation1.setObjectName("labelNavigation1")
        self.formKeys.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.labelNavigation1)
        self.horizontalLayout_43 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_43.setSpacing(4)
        self.horizontalLayout_43.setObjectName("horizontalLayout_43")
        self.plus1 = QKeySequenceFlexibleEdit(self.tabKeys)
        self.plus1.setObjectName("plus1")
        self.horizontalLayout_43.addWidget(self.plus1)
        self.plus1_ = QKeySequenceFlexibleEdit(self.tabKeys)
        self.plus1_.setObjectName("plus1_")
        self.horizontalLayout_43.addWidget(self.plus1_)
        self.formKeys.setLayout(1, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_43)
        self.spinNavigation1 = QtWidgets.QSpinBox(self.tabKeys)
        ...
        self.formKeys.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.spinNavigation1)
        self.spinNavigation2 = QtWidgets.QSpinBox(self.tabKeys)
        ...
        self.formKeys.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.spinNavigation2)
        self.spinNavigation3 = QtWidgets.QSpinBox(self.tabKeys)
        ...
        self.formKeys.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.spinNavigation3)
        self.spinNavigation4 = QtWidgets.QSpinBox(self.tabKeys)
        ...
        self.formKeys.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.spinNavigation4)
        self.formLayout_3.setLayout(3, QtWidgets.QFormLayout.SpanningRole, self.formKeys)
        ...
        spacerItem5 = QtWidgets.QSpacerItem(20, 1276, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.comboScaleArt.setCurrentIndex(0)
        ...
        self.comboSnapshotCtrl.setCurrentIndex(0)
        self.comboSnapshotAlt.setCurrentIndex(0)
        ...
        self.checkFocusDoubleClick.toggled['bool'].connect(self.checkFocusMinimized.setDisabled) # type: ignore
        self.checkFocusDoubleClick.toggled['bool'].connect(self.checkFocusMinimizedToTray.setDisabled) # type: ignore
        ...
        settingsDialog.setTabOrder(self.checkFocusMinimizedToTray, self.checkClampOnResize)
        ...
        settingsDialog.setTabOrder(self.comboScaleArt, self.checkSnapVideos)
...
"of the screen it\'s on when opening media."))
        ...
        self.label_53.setText(_translate("settingsDialog", "Image scaling:"))
        ...
        self.label_52.setText(_translate("settingsDialog", "Animated GIF scaling:"))
...
"have the \"media opened\" marquee enabled below."))
        ...
        self.checkAutoplaySameMime.setToolTip(_translate("settingsDialog", "If checked, Autoplay will only play media with\n"
"the same mime type (video, audio, or image)\n"
"as the file you started with."))
        self.checkAutoplaySameMime.setText(_translate("settingsDialog", "Ignore other mime types while Autoplay is on"))
        self.checkAutoplayIgnoreFocus.setToolTip(_translate("settingsDialog", "If checked, files that are opened through\n"
"autoplay will never raise or focus the window."))
        self.checkAutoplayIgnoreFocus.setText(_translate("settingsDialog", "Ignore focus settings while Autoplay is on"))
...
"relative to the current size of your window."))
        ...
        self.checkZoomAutoDisable1x.setToolTip(_translate("settingsDialog", "If checked and \"Minimum zoom\" is set to 1.00x,\n"
...
"simply be replayed as it is the most recent file."))
        ...
        self.groupBox_10.setTitle(_translate("settingsDialog", "Navigation keys behavior"))
...
"(default hotkey), you\'ll be placed back at the start."))
        self.checkNavigationWrap.setText(_translate("settingsDialog", "Navigation wraps around progress bar"))
        self.groupBox_11.setTitle(_translate("settingsDialog", "Miscellaneous behavior"))
...
"around to \"disabled\" first."))
        ...
        self.label_59.setText(_translate("settingsDialog", "Forward (recent files)"))
        self.forward.setKeySequence(_translate("settingsDialog", "Alt+Right"))
        self.label_60.setText(_translate("settingsDialog", "Back (recent files)"))
        ...
        self.labelNavigation1.setText(_translate("settingsDialog", "-1 second"))
