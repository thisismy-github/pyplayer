...
"skip over files that have been marked for deletion.")
        ...
        self.menuVideo.addAction(self.actionIsolateVideo)
...
"Right-click for more options."))
        ...
        self.actionIsolateVideo.setText(_translate("MainWindow", "&Isolate video"))
        self.actionIsolateAudio.setText(_translate("MainWindow", "&Isolate audio track"))
