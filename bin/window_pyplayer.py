...
"skip over files that have been marked for deletion.")
        ...
        self.actionSnapshotExploreLast = QtWidgets.QAction(MainWindow)
        self.actionSnapshotExploreLast.setObjectName("actionSnapshotExploreLast")
        self.actionSnapshotCopyLast = QtWidgets.QAction(MainWindow)
        self.actionSnapshotCopyLast.setObjectName("actionSnapshotCopyLast")
        ...
        self.menuSnapshots.addAction(self.actionSnapshotExploreLast)
        self.menuSnapshots.addAction(self.actionSnapshotCopyLast)
...
"for deletion, without actually deleting them."))
        ...
        self.actionSnapshotExploreLast.setText(_translate("MainWindow", "&Explore last snapshot"))
        self.actionSnapshotCopyLast.setText(_translate("MainWindow", "Copy last snapshot path"))
